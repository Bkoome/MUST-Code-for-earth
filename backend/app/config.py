...
# The one SQLite artifact: disaster catalogue (tools/catalogue) plus the missed-opportunity
# tables written over it by tools/moi. Absent file, or absent tables, disables those feeds.
